...
mixin _$TransactionResponse {
 ...
 int get id; AccountBrief get account; Category get category; String get amount; DateTime get transactionDate; DateTime get createdAt; DateTime get updatedAt; String? get comment;
...
@override
String toString() {
  return 'TransactionResponse(id: $id, account: $account, category: $category, amount: $amount, transactionDate: $transactionDate, createdAt: $createdAt, updatedAt: $updatedAt, comment: $comment)';
}
...
@useResult
$Res call({
 int id, AccountBrief account, Category category, String amount, DateTime transactionDate, DateTime createdAt, DateTime updatedAt, String? comment
});
...
class _TransactionResponse implements TransactionResponse {
  const _TransactionResponse({required this.id, required this.account, required this.category, required this.amount, required this.transactionDate, required this.createdAt, required this.updatedAt, this.comment});
