...
/// @nodoc
mixin _$AccountHistoryResponse implements DiagnosticableTreeMixin {
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'AccountHistoryResponse'))
    ..add(DiagnosticsProperty('accountId', accountId))..add(DiagnosticsProperty('accountName', accountName))..add(DiagnosticsProperty('currency', currency))..add(DiagnosticsProperty('currentBalance', currentBalance))..add(DiagnosticsProperty('history', history));
}
...
class _AccountHistoryResponse with DiagnosticableTreeMixin implements AccountHistoryResponse {
